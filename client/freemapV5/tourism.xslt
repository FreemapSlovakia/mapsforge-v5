    ...
    <rule e="node" k="information" v="guidepost">
      <rule e="node" k="hiking" v="yes">
        <rule e="node" k="*" v="*" zoom-min="12" zoom-max="12">
          <symbol id="guide_hiking" src="file:/poi/guidepost_hiking.svg" symbol-width="12" priority="-20" display="always"/>
        </rule>
        <rule e="node" k="*" v="*" zoom-min="13">
          <symbol id="guide_hiking" src="file:/poi/guidepost_hiking.svg" symbol-width="20" priority="-20" display="always"/>
          ...
          <rule e="node" k="*" v="*" zoom-min="16">
            <caption k="name" symbol-id="guide_hiking" position="above" font-style="bold" font-size="12" fill="#000000" stroke="#DBFFA0" stroke-width="2" priority="-10" display="always"/>
          </rule>
