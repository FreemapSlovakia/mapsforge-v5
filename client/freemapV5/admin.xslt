  ...
  <xsl:template name="admin">
    <rule cat="boundaries" e="way" k="admin_level" v="*">
      <rule e="way" k="admin_level" v="11" zoom-min="15">
        <line stroke="#50EDC2EC" stroke-width="6" scale="none"/>
        <line stroke="#9A3996" stroke-width="0.1" stroke-dasharray="1,5" scale="none"/>
      </rule>
      <!-- SK KU -->
      <rule e="way" k="admin_level" v="10" zoom-min="10">
        <line stroke="#50EDC2EC" stroke-width="2" scale= "none"/>
        <line stroke="#9A3996" stroke-width="0.8" stroke-dasharray="2,8" scale="none"/>
      </rule>
      <!-- SK obec -->
      <rule e="way" k="admin_level" v="9" zoom-min="10">
        <line stroke="#50EDC2EC" stroke-width="1" />
        <line stroke="#9A3996" stroke-width="0.8" stroke-dasharray="10,10" scale="none"/>
      </rule>
      <!-- SK okres -->
      <rule e="way" k="admin_level" v="8" zoom-min="10">
        <line stroke="#50EDC2EC" stroke-width="1.5"  scale="none"/>
      ...
      <!-- SK BA, KE -->
      <rule e="way" k="admin_level" v="6" zoom-min="8">
        <line stroke="#50EDC2EC" stroke-width="1.5"  scale="none"/>
      ...
      <!-- SK VUC -->
      <rule e="way" k="admin_level" v="4" zoom-min="8">
        <line stroke="#50EDC2EC" stroke-width="2"  scale="none"/>
        <line stroke="#9A3996" stroke-width="1" stroke-dasharray="15, 5, 5, 5" scale="none"/>
      </rule>
      <!-- SK -->
      <rule e="way" k="admin_level" v="3" zoom-min="8">
        <line stroke="#50EDC2EC" stroke-width="3"  scale="none"/>
        <line stroke="#9A3996" stroke-width="1" stroke-dasharray="15, 10, 5, 10" scale="none"/>
      </rule>
      <rule e="way" k="admin_level" v="2">
        <line stroke="#50EDC2EC" stroke-width="4"  scale="none"/>
